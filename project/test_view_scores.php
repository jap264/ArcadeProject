...
if (isset($id)) {
    $db = getDB();
    $stmt = $db->prepare("SELECT score.id, username, score, score.created, Users.username FROM Scores as score JOIN Users on score.user_id = Users.id where score.id = :id");
